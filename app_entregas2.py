...
# =================================================================
# 3. PROCESSAR AÇÃO DO POPUP (CONCLUIR) - DEVE FICAR AQUI NO TOPO
# =================================================================
...
# =================================================================
# 4. INTERFACE DE BUSCA (APENAS UMA VEZ)
# =================================================================
...
# Lógica do ponto Laranja (mais próximo)
...
<body>
    ...
    <script>
        ...
        pontos.forEach(function(p) {{
            ...
            if (!p.concluido) {{
                content += '<a href="?concluir='+p.id+'" target="_self" class="popup-btn" style="background:#28a745;">✅ CONCLUIR</a>';
            }}
            content += '</div>';
